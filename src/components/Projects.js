  ...
  const projects = [
    {
      ...
      description: "Frontend: ReactJs",
      imgUrl: projImg1,
      
    },
    {
      title: "Chat App - MERN stack",
      description: "Frontend: React, Backend:NodeJs, Database:Mongodb",
      imgUrl: projImg2,
    },
    {
      title: "Github User Search",
      description:
        "Frontend: ReactJs,Auth0 for authentication,Use Github Api for fectching data",
      imgUrl: projImg3,
    },
    {
    ...
    },
    {
      ...
      description: "Design & Development:Wordpess, Backend: Mysql ",
      imgUrl: projImg5,
    },
  ];
          ...
          <Col size={12}>
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  <h2>Projects</h2>
                  <p>Deigning and Developing the website from scrach.</p>
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Tab.Pane eventKey="third">
                        <p>
                          Worked along with development team and engaged in the
